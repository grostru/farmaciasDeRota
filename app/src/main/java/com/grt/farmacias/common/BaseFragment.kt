...
import com.grt.farmacias.ui.deGuardia.DeGuardiaFragment
import com.grt.farmacias.ui.dialog.DialogData
...
abstract class BaseFragment<T:ViewBinding,VM: BaseViewModel> : Fragment() {
    ...
    private fun onObserveDialogData(dialogData: DialogData) {
        if(dialogData.show){
            dialogMsg.show(parentFragmentManager, DeGuardiaFragment::class.java.name,dialogData.description){
